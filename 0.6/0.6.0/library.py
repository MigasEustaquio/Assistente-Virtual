...
def salva_calendario(query, data):
	...
	print("Xion: Okay. I will remind you " + query + " tomorrow\n")
...
#
	...
	print("Xion: Okay. I will remind you " + query + " on " + fala + "\n")
...
def salva_calendario_semana(query, data):	#FUNÇÃO NEXT FALTA IMPLEMENTAR
	...
	print("Xion: Okay. I will remind you " + query + " " + fala + "\n")
	...
	if 'today' in query:
		...
		for x in lista_eventos:
			...
			if x > lista_eventos[0]:
				...
				print("You also asked me to remind you " + eventos[str(x)][0] + " today\n")
			else:

				sai_som2("You asked me to remind you " + eventos[str(x)][0] + " today")
				print("You asked me to remind you " + eventos[str(x)][0] + " today\n")
		...
		for x in lista_eventos:
			...
			if x > lista_eventos[0]:
				...
				print("You also asked me to remind you " + eventos[str(x)][0] + " tomorrow\n")
			else:

				sai_som2("You asked me to remind you " + eventos[str(x)][0] + " tomorrow")
				print("You asked me to remind you " + eventos[str(x)][0] + " tomorrow\n")
		...
		for x in lista_eventos:
			...
			if x > lista_eventos[0]:
				...
				print("You also asked me to remind you " + eventos[str(x)][0] + " on " + query + "\n")
			else:

				sai_som2("You asked me to remind you " + eventos[str(x)][0] + " on " + query)
				print("You asked me to remind you " + eventos[str(x)][0] + " on " + query + "\n")
